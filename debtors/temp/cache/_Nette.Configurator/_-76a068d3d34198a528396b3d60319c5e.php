<?php //netteCache[01]000418a:2:{s:4:"time";s:21:"0.65561900 1376600536";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:71:"/data/web/virtuals/47669/virtual/www/subdom/daty/app/config/config.neon";i:2;i:1376600465;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:77:"/data/web/virtuals/47669/virtual/www/subdom/daty/app/config/config.local.neon";i:2;i:1376575069;}}}?><?php
// source: /data/web/virtuals/47669/virtual/www/subdom/daty/app/config/config.neon production
// source: /data/web/virtuals/47669/virtual/www/subdom/daty/app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	public $classes = array(
		'nette\\object' => FALSE, //: nette.cacheJournal, cacheStorage, nette.httpRequestFactory, httpRequest, httpResponse, nette.httpContext, session, nette.userStorage, user, application, nette.presenterFactory, nette.mailer, nette.database, container,
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/data/web/virtuals/47669/virtual/www/subdom/daty/app',
			'wwwDir' => '/data/web/virtuals/47669/virtual/www/subdom/daty/www',
			'debugMode' => FALSE,
			'productionMode' => TRUE,
			...
			'tempDir' => '/data/web/virtuals/47669/virtual/www/subdom/daty/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/data/web/virtuals/47669/virtual/www/subdom/daty/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/data/web/virtuals/47669/virtual/www/subdom/daty/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory('/data/web/virtuals/47669/virtual/www/subdom/daty/app', $this);
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/data/web/virtuals/47669/virtual/www/subdom/daty/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
